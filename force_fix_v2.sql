-- NUCLEAR OPTION: Fix All Permissions Forcefully (v2 - Fixed UUID)
...
-- 5. Ensure settings exist (Fixed UUID issue)
-- Using gen_random_uuid() to generate a valid UUID for the ID column
INSERT INTO public.settings (id, showroom_name)
SELECT gen_random_uuid(), 'Premium Motors'
