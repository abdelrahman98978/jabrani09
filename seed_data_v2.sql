-- Final fixed seed data script
-- Removed 'is_active' column from cars insert as it does not exist in the schema

-- 1. Insert Brands (Success guaranteed)
...
-- 2. Insert Cars (Removed is_active column)
-- Mercedes S-Class
DO $$
DECLARE
  b_id uuid;
BEGIN
  ...
  IF b_id IS NOT NULL THEN
    INSERT INTO public.cars (
      ...
      main_image, images, 
      status, is_featured, is_new, has_discount
    ) 
    SELECT 
